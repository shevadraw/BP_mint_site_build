    ...
    <s.Screen>
      ...
      >
        <ResponsiveWrapper1 flex={1} style={{ padding: 2 }} test>
          <s.Container1 flex={0} jc={"center"} ai={"center"}>
            <Link href="#">
              <Icon>
